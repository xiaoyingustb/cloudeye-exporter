...
|service_id<br>（服务）|tp_999|TP99|ms|
|service_id<br>（服务）|tp_99|TP99.9|ms|
...
|service_id,model_id<br>（服务,模型实例）|npu_util|NPU使用率|%|
|service_id,model_id<br>（服务,模型实例）|npu_mem_usage|NPU显存使用率|%|